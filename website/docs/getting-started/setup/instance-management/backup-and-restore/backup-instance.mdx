...
:::info What is and isn’t in this backup

`appsmithctl backup` includes the Appsmith MongoDB database, configuration, and Git data. It does **not** include external PostgreSQL used by Keycloak or Temporal. For criticality of each component (MongoDB, PostgreSQL, Redis, EFS or persistent volumes) and how to plan around them, see [Data criticality and backup considerations](/getting-started/setup/deployment-architecture#data-criticality-and-backup-considerations).
